...
To simulate a game, we performed this Monte Carlo Algorithm (see Algorithm~\ref{alg:monte_carlo_algorithm} in Appendix~\ref{mcmc_app}) that acted like a random walk through the Markov Chain (Note that the {\tt KDE\_times()} is a KDE model fit on the amount of seconds that transpired between 
...
\begin{figure}
    \centering
    \subfigure[]{\includegraphics[width=0.6\textwidth]{images/good_xgb_example.png}} 
    \subfigure[]{\includegraphics[width=0.6\textwidth]{images/good_xgb_example(2).png}} 
