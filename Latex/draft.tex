...
and strategies. Leveraging the {\tt .predict\_proba()} method of XGBoost, we generated 
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=0.9\textwidth]{images/good_xgb_example.png}} 
    \subfigure[]{\includegraphics[width=0.9\textwidth]{images/good_xgb_example(2).png}} 
    ...
    Notice the probability shifts after one team scores a goal.  \\
        ...
        shift in probabilities even when no goals are scored. This suggests
        the XGBoost model is able to pick up on momentum shifts.}
...
We see this in the probability graph below, where the changes in probability correspond to the goals scored in the game.
