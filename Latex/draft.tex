...
The models were each trained on prior seasons, and tested on the most recent 2022-2023 season. This split was chosen because in practice our model would have access to historical data but not have access to the current season's data as it happens.
